...
int require(token_t* token, dynamic_string* string);
int program_body(token_t* token, dynamic_string* string);
int func_decl(token_t* token, dynamic_string* string);
int func_def(token_t* token, dynamic_string* string);
int func_call(token_t* token, dynamic_string* string);
